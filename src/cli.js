...
import { init_auto_href, parse_auto_href_cli_args } from "./init.js";
const help_text = `
svelte-auto-href

Usage:
  svelte-auto-href init [--global] [--editor <name>]
...
/**
 * Runs the `svelte-auto-href` command line interface.
 *
 * @example
 * ```ts

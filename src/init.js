 ...
 */
export function parse_auto_href_cli_args(args) {
 ...
 */
export async function init_auto_href(options = {}) {
 ...
 */
export function patch_auto_href_vscode_settings(text) {
...
function merge_string_array(existing, additions) {

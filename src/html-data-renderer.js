import { get_href_completions } from "./editor.js";
/**
 ...
 */
export function render_html_data(manifest) {
...
function make_tag(name, attribute, values) {
  return {
    name,
    attributes: [{
      name: attribute,
...
function is_markup_completion(completion) {
  return completion.insert_text.startsWith("/") &&
    !completion.insert_text.includes("${string}");
}

...
/**
 * VS Code-family editors whose user settings locations are known.
 *
 * @example
 * ```ts
 * const editor: VscodeBasedEditor = "cursor";
 * ```
 *
 * @since 0.1.0
 */
export type VscodeBasedEditor = keyof typeof editor_folders;

/**
 * Operating systems supported by the init command for global settings writes.
 *
 * @example
 * ```ts
 * const platform: SupportedPlatform = "win32";
 * ```
 *
 * @since 0.1.0
 */
...
/**
 * Options for resolving a VS Code-family user settings file.
 *
 * @example
 * ```ts
...
/**
 * Options for the `svelte-auto-href init` operation.
 *
 * @example
 * ```ts
 * await init_auto_href({ global: true, editor: "cursor" });
 * ```
 *
 * @since 0.1.0
 */
...
/**
 * Result returned after an init command updates or verifies settings.
 *
 * @example
 * ```ts
 * const result = await init_auto_href();
 * console.log(result.changed, result.settings_path);
 * ```
 *
 * @since 0.1.0
 */
...
/**
 * Result of patching VS Code settings text.
 *
 * @example
 * ```ts
 * const patched = patch_auto_href_vscode_settings("{}");
 * ```
 *
 * @since 0.1.0
 */
...
/**
 * Parses CLI arguments for `svelte-auto-href`.
 *
 * @example
 * ```ts
 * const options = parse_auto_href_cli_args(["init", "--global", "--editor", "cursor"]);
 * ```
 *
 * @since 0.1.0
...
/**
 * Writes VS Code-family settings for native href autocomplete.
 *
 * @example
 * ```ts
 * await init_auto_href();
 * await init_auto_href({ global: true, editor: "cursor" });
 * ```
 *
 * @since 0.1.0
...
/**
 * Adds the generated `svelte-auto-href` custom-data path to VS Code settings.
 *
 * @example
 * ```ts
